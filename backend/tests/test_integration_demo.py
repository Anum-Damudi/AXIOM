...
def test_end_to_end_demo_scenario(client, auth_headers):
    """
    ...
    resp1 = client.post("/api/v1/cases/C001/reports", json={"report_text": rep1_text}, headers=auth_headers)
    ...
    resp5 = client.post("/api/v1/cases/C005/reports", json={"report_text": rep5_text}, headers=auth_headers)
    ...
    related_resp = client.get("/api/v1/cases/C001/related-cases", headers=auth_headers)
